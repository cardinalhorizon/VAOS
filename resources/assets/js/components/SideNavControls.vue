<template>
    <nav class="sidebar-nav">
        <ul class="nav">
            <li class="nav-item">
                <a class="nav-link" v-bind:href="'/admin'">
            ...
            <li class="nav-item nav-dropdown">
                ...
                <ul class="nav-dropdown-items">
                    <li class="nav-item">
                        <a class="nav-link" v-bind:href="'/admin/'+ activeAirline.id +'/fleet'" target="_top">
            ...
            <li class="nav-item nav-dropdown">
                ...
                <ul class="nav-dropdown-items">
                    <li class="nav-item">
                        <a class="nav-link" v-bind:href="'/admin/'+ activeAirline.id +'/schedule'" target="_top">
            ...
            <li class="nav-item nav-dropdown">
                ...
                <ul class="nav-dropdown-items">
                    <li class="nav-item">
                        <a class="nav-link" v-bind:href="'/admin/'+ activeAirline.id +'/airports'" target="_top">
                            <i class="nav-icon fa fa-caret-right"></i> Airport Management</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" v-bind:href="'/admin/'+ activeAirline.id +'/hubs'" target="_top">
            ...
            <li class="nav-item nav-dropdown">
                ...
                <ul class="nav-dropdown-items">
                    <li class="nav-item">
                        <a class="nav-link" v-bind:href="'/admin/'+ activeAirline.id +'/map'" target="_top">
                            <i class="nav-icon fa fa-caret-right"></i> Live Map</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" v-bind:href="'/admin/'+ activeAirline.id +'/flights'" target="_top">
                            <i class="nav-icon fa fa-caret-right"></i> Flight Management</a>
                    </li>
                </ul>
            </li>
            <li class="nav-item">
                <a class="nav-link" v-bind:href="'/admin/'+ activeAirline.id +'/typeratings'">
            ...
            <template v-if="systemAdmin">
                ...
                <li class="nav-item nav-dropdown">
                    ...
                    <ul class="nav-dropdown-items">
                        <li class="nav-item">
                            <a class="nav-link" v-bind:href="'/admin/users'" target="_top">
